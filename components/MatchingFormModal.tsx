...
import { Match, MatchStatus, Car, CarStatus, Salesperson } from '../types';
...
const MatchingFormModal: React.FC<MatchingFormModalProps> = ({ isOpen, onClose, onSave, matchToEdit, carToMatch, cars, availableCars, userRole, salespersons }) => {
  ...
  if (carToMatch) {
    carOptionsMap.set(carToMatch.id!, carToMatch);
  }
            ...
            <fieldset disabled={userRole === 'user'} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  required
                  disabled={!!matchToEdit || !!carToMatch}
