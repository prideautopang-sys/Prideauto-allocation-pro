...
interface ConfirmDeleteModalProps {
  ...
  onConfirm: () => void;
  car: Car | null;
  // FIX: Added 'sold' to the viewContext type to match the 'View' type in App.tsx and resolve the type error.
  viewContext: 'allocation' | 'stock' | 'matching' | 'stats' | 'sold' | null;
}
